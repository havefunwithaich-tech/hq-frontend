...
const VIDEO_BASE_URL = "https://cdn.havefunwithaich.com/portrait";
  ...
  return (
    <div className="page-wrapper">
      ...
      {!config.isTheater && (
        <div className="details-section">
          <div className="content-block title-block">
             <h1 style={{ margin: "0", fontSize: "1.6rem", textAlign: "center", color: "#66cfff", letterSpacing:"2px" }}>{title}</h1>
          </div>
      ...
      <style jsx>{`
        ...
        .video-main-container { width: 100%; max-width: 800px; margin: 0 auto; }
        .video-container-wrapper { width: 100%; height: 85vh; background: #000; display: flex; justify-content: center; align-items: center; z-index: 20; overflow: hidden; position: relative; }
        .video-container-wrapper.theater-mode { position: fixed; top: 0; left: 0; width: 100%; height: 100dvh; z-index: 9999; }
